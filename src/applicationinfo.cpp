...
#define PROG_IPC_NAME "com.peachnote.Peachnote"	// must not contain '\\' character on Windows
#define PROG_OPTIONS_NS "http://psi-im.org/options";
#define PROG_STORAGE_NS "http://psi-im.org/storage";
#ifdef Q_WS_MAC
#define PROG_APPCAST_URL "http://peachnote.com/appcast/peachnote-mac.xml";
#else
